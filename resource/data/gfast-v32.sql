...
CREATE DATABASE `sx` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `sx`;
...
INSERT INTO `casbin_rule` VALUES ('p', '1', '152', 'ALL', '', '', '');
...
INSERT INTO `sys_auth_rule` VALUES (152, 0, '/api/v1/online_meeting/meetings/list', '会议列表', '', '', '附件管理删除', 2, 0, 0, '', '', 0, 'sys_admin', 0, 0, 1, '', 0, '', NULL, NULL);
