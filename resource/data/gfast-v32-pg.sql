...
INSERT INTO "tools_gen_table" VALUES (95, 'demo_snow_id', '雪花ID测试', 'DemoSnowId', 'crud', 'internal/app/demo', 'demo', 'demo_snow_id', '雪花ID测试', 'gfast', '', '2023-09-19 15:34:46', '2023-09-20 14:48:07', '', 'f', 'id', 'asc', 'f', 'f', 'f', 'f', 'f', NULL, 0);
...
INSERT INTO "tools_gen_table_column" VALUES (997, 95, 'id', 'ID', 'bigint(20) unsigned', 'uint64', 'number', 'Id', 'id', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 1, 1, 1, 1, 'EQ', 'input', '', '', '', '', '', '', '', '', 12, 1, 'f', 100, 'f', 'f', 'f', '', '');
INSERT INTO "tools_gen_table_column" VALUES (998, 95, 'name', '姓名', 'varchar(30)', 'string', 'string', 'Name', 'name', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 2, 2, 2, 2, 'LIKE', 'input', '', '', '', '', '', '', '', '', 12, 1, 'f', 100, 'f', 'f', 'f', '', '');
INSERT INTO "tools_gen_table_column" VALUES (999, 95, 'age', '年龄', 'int(10) unsigned', 'uint', 'number', 'Age', 'age', 'f', 'f', 'f', 'f', 'f', 'f', 'f', 3, 3, 3, 3, 'EQ', 'input', '', '', '', '', '', '', '', '', 12, 1, 'f', 100, 'f', 'f', 'f', '', '');
